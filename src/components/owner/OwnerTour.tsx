...
export default function OwnerTour({ ownerFirstName, onClose, onNavigateSupport }: OwnerTourProps) {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      title: 'كل تواصل ونقاط ولاء داخل التطبيق',
      body: (
        <>
          محادثاتك مع كل ضيف محفوظة في تاب <strong className="text-[var(--color-owner-primary)]">"المحادثات"</strong> ومربوطة بالحجز نفسه — ما بتنمسحش حتى لو قفلت التطبيق. الضيف بياخد نقاط ولاء على كل جنيه بيدفعه، وده اللي بيخليه يرجع يحجز عندك تاني ومش يبعت في واتساب من برة.
        </>
      ),
      tip: '🔒 بيانات تواصل الضيف ورقمك محميين — بس المحادثة هي القناة.',
    },
    {
      icon: HelpCircle,
      chip: 'احنا معاك',
