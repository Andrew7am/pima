...
import { buildQuestions } from './matchQuestions';
import {
...
// MATCH_LENGTH/shuffle/buildQuestions now live in ./matchQuestions so the
// random-match screen can start a real match with the same question shape.
