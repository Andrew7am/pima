      ...
      >
        ...
        {!isOpen && unreadCount > 0 && (
          <motion.span
            ...
            className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-rose-500 text-white text-[9px] font-black flex items-center justify-center border-2 border-[var(--color-play-bg)]"
          >
